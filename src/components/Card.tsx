...
const Card = ({ mainTxt, desc, pathToImg, imgAlt }: CardProps) => {
    return (
        <div className="flex justify-around items-center w-full gap-2 bg-neutral-50 bg-opacity-40 px-2 py-4 border-4 border-neutral-50 border-opacity-10 shadow-sm rounded-2xl">
