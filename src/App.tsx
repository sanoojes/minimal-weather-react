    ...
    return (
        <>
            ...
            <main className="flex justify-center items-center bg-neutral-950 h-screen w-screen">
                <div className="flex flex-col space-y-4 justify-between w-9/12 h-5/6 max-w-screen-md bg-gradient-to-tl from-violet-700 to-pink-800 rounded-2xl px-4 py-2 overflow-scroll">
